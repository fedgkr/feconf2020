...
export const sessionList: Session[] = [
  ...
  {
    title: '디자인 시스템과 다크모드',
    description: '초창기 스타트업에서 디자인 시스템은 중요하지 않지만, 서비스와 비즈니스가 커지면 디자인의 일관성을 지킬 수 있고 컴포넌트를 재사용해서 개발을 빠르게 도울 수 있는 디자인 시스템의 필요성을 느끼게 됩니다.\n' +
    '토스 디자인 시스템(TDS)의 웹버전을 React로 유지보수하면서 어떤 크고 작은 문제가 있었는지 다뤄봅니다. 그중에서도 특히 디자인 시스템을 이용해 다크모드를 어떻게 구현했는지 자세히 살펴봅니다.',
    track: Track.A,
    startTime: '15:30',
    endTime: '16:10',
    speaker: {
